...
#>
function New-DedicatedIPv4Address {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: New-DedicatedIPv4Address' | Write-Debug
        ...
        $LocalVarUri = '/oapi/v1/dedicated_addresses/ipv4'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "DedicatedIPv4Address" `
...
DedicatedIPv4Address[]
#>
function Invoke-ListDedicatedIPv4Addresses {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-ListDedicatedIPv4Addresses' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
