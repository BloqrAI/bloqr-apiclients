...
function ConvertFrom-JsonToQueryLogItem {
    ...
    Process {
        ...
        $AllProperties = ('asn', 'category_type', 'client_country', 'company_id', 'device_id', 'dns_proto_type', 'dns_request_type', 'dns_response_type', 'dns_server_id', 'dnssec', 'domain', 'filtering_info', 'network', 'response_country', 'time_iso', 'time_millis')
