...
namespace AdGuard.ApiClient.Api
{
    ...
    public interface IReferenceDataApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;ParentalControlFilteringCategory&gt;</returns>
        ...
        /// </remarks>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;ParentalControlFilteringCategory&gt;</returns>
        ApiResponse<List<ParentalControlFilteringCategory>> ListParentalControlFilteringCategoriesWithHttpInfo();
        /// <summary>
        /// Lists web services
        /// </summary>
        /// <remarks>
    ...
    public interface IReferenceDataApiAsync : IApiAccessor
    {
        ...
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ParentalControlFilteringCategory&gt;</returns>
        System.Threading.Tasks.Task<List<ParentalControlFilteringCategory>> ListParentalControlFilteringCategoriesAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ParentalControlFilteringCategory&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ParentalControlFilteringCategory>>> ListParentalControlFilteringCategoriesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Lists web services
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ReferenceDataApi : IDisposable, IReferenceDataApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceDataApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public ReferenceDataApi(AdGuard.ApiClient.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public ReferenceDataApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ReferenceDataApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ReferenceDataApi(HttpClient client, AdGuard.ApiClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ReferenceDataApi(AdGuard.ApiClient.Client.ISynchronousClient client, AdGuard.ApiClient.Client.IAsynchronousClient asyncClient, AdGuard.ApiClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Lists filter lists Returns available filter lists for the current locale. Use this endpoint to retrieve filter definitions before applying them to DNS server settings. 
        /// </summary>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;FilterList&gt;</returns>
        ...
        /// <summary>
        /// Lists all parental control filtering categories Returns all available parental control filtering categories. Use this endpoint to retrieve categories for configuring parental control settings on a DNS server. 
        /// </summary>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;ParentalControlFilteringCategory&gt;</returns>
        public List<ParentalControlFilteringCategory> ListParentalControlFilteringCategories()
        {
            AdGuard.ApiClient.Client.ApiResponse<List<ParentalControlFilteringCategory>> localVarResponse = ListParentalControlFilteringCategoriesWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;ParentalControlFilteringCategory&gt;</returns>
        public AdGuard.ApiClient.Client.ApiResponse<List<ParentalControlFilteringCategory>> ListParentalControlFilteringCategoriesWithHttpInfo()
        {
            AdGuard.ApiClient.Client.RequestOptions localVarRequestOptions = new AdGuard.ApiClient.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<ParentalControlFilteringCategory>>("/oapi/v1/parental_control_categories", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListParentalControlFilteringCategories", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;ParentalControlFilteringCategory&gt;</returns>
        public async System.Threading.Tasks.Task<List<ParentalControlFilteringCategory>> ListParentalControlFilteringCategoriesAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            AdGuard.ApiClient.Client.ApiResponse<List<ParentalControlFilteringCategory>> localVarResponse = await ListParentalControlFilteringCategoriesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ParentalControlFilteringCategory&gt;)</returns>
        public async System.Threading.Tasks.Task<AdGuard.ApiClient.Client.ApiResponse<List<ParentalControlFilteringCategory>>> ListParentalControlFilteringCategoriesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ParentalControlFilteringCategory>>("/oapi/v1/parental_control_categories", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Lists web services Returns a list of known web services with their identifiers and icons. Use this endpoint to get service data for parental control configuration. 
        /// </summary>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;WebService&gt;</returns>
