...
namespace AdGuard.ApiClient.Api
{
    ...
    public partial class DedicatedIPAddressesApi : IDisposable, IDedicatedIPAddressesApi
    {
        ...
        /// <summary>
        /// Allocates new dedicated IPv4 Allocates a new dedicated IPv4 address for the account. Use this endpoint when you need a static IP address for DNS resolution. 
        /// </summary>
        ...
        /// <summary>
        /// Lists allocated dedicated IPv4 addresses Returns a list of dedicated IPv4 addresses allocated for the account. Use this endpoint to review available dedicated addresses before linking them to devices. 
        /// </summary>
        /// <exception cref="AdGuard.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
